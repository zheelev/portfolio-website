...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects">
      ...
      <h3 className="text-center text-sm mt-8 text-white">In this section, you will find projects where I have used React, Vue, JavaScript, and other modern technologies. Each project showcases my approach to development and attention to detail.</h3>
